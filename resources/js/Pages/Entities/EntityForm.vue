  ...
  <AuthenticatedLayout>
    <div class="max-w-2xl mx-auto p-6">
      ...
      <form @submit.prevent="save" class="space-y-4">
        <div v-for="title in titles" :key="title.field" class="flex flex-col">
          <label class="text-sm font-medium text-gray-600 mb-1">
            {{ title.caption }}
          </label>
          <input v-model="form[title.field]" class="border rounded-lg p-2 focus:ring focus:ring-blue-100" />
        </div>
